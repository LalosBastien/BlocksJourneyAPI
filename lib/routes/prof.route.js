...
router.delete('/student/:id', authMiddleware, requiredRole(2), UserController.delete);
router.post('/renew/:id:', authMiddleware, requiredRole(2), validator(renewStudent), AuthenticationController.renewStudent);
