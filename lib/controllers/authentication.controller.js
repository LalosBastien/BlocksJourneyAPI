...
import { generatePasswordToken } from '../util/tokenUtil';
    ...
    static async autoRegisterStudents(req, res) {
        ...
        try {
            ...
            for (const student of toCreate) {
                ...
                student.login = await profService.generateStudentLogin(req.user, student);
                const theRole = await roleService.findByField('accessLevel', 1, null);
                student.roleId = theRole.id;
